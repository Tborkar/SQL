...
UPDATE ev_data_norm
SET `Range` = cast(replace(`Range`, ' km', '') as unsigned);
...
select Brand, Model, RapidCharge from ev_data_norm where RapidCharge = "No";

select distinct(`Range`) from ev_data_norm;